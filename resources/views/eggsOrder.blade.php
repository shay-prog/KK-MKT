...
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
  <h4><span class="welcome">welcome back our esteamed customer<b> {{Auth::user()->fullname}}</b> <br> Kindly feed us with your information<br> that will enable Supply <b>{{$n}}</b> eggs</span></h4>
