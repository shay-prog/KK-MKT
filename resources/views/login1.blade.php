...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="text-muted page-title-alt">Welcome to Alpha Tech Enterprises</p>
        </div>
    </div>
                    ...
                    <table class="table table-actions-bar m-b-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><img src="alpha/alpha/assets/images/products/iphone.jpg" class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone </td>
                            ...
                            <tr>
                                ...
                                <td><img src="alpha/alpha/assets/images/products/samsung.jpg" class="thumb-sm pull-left m-r-10" alt=""> Samsung Phone </td>
                            ...
                            <tr>
                                ...
                                <td><img src="alpha/alpha/assets/images/products/imac.jpg" class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone </td>
                            ...
                            <tr>
                                ...
                                <td><img src="alpha/alpha/assets/images/products/macbook.jpg" class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone </td>
                            ...
                            <tr>
                                ...
                                <td><img src="alpha/alpha/assets/images/products/lumia.jpg" class="thumb-sm pull-left m-r-10" alt=""> Lumia iPhone </td>
                                <td><span class="text-custom">+$230</span></td>
                                <td>
                                    <a href="#" class="table-action-btn"><i class="md md-edit"></i></a>
                                    <a href="#" class="table-action-btn"><i class="md md-close"></i></a>
