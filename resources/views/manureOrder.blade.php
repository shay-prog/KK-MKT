...
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
  <h4><span class="welcome">welcome back our esteamed customer<b> {{Auth::user()->fullname}}</b> <br> Kindly feed us with your information<br> that will enable us deliver your <b>{{$n}} </b>Order</span></h4>
...
<p class="float">
  <label for="capacity"><i class=""></i>Capacity (Tonnes/KGs)</label><br>
    <input type="text" id="capacity" placeholder="Capacity in Tonnes/KGs" class="form-control @error('capacity') is-invalid @enderror"name="capacity" required>
    @error('capacity')
        <span class="invalid-feedback" role="alert">
            <strong>{{ $message }}</strong>
        </span>
...
<p class="float">
  <label for="date"><i class="icon-Date"></i>Collection Date</label><br>
