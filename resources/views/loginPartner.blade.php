...
@section('content')
<form action="{{route('registerPartner')}}"  method="post" class="form-2" align="center" enctype="multipart/form-data" >
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
  <h4><span class="welcome">welcome back our esteamed Partner<b> {{Auth::user()->fullname}}</b> <br> Kindly feed us with your information<br> </span></h4>
...
<p class="float">
    <label for="age"><i class=""></i>Poulty Products</label><br>
<input type="checkbox" name="check_list[]" value="eggs"><label>&nbspEggs&nbsp&nbsp</label>
<input type="checkbox" name="check_list[]" value="chicks"><label>&nbspChicks&nbsp&nbsp</label>
<input type="checkbox" name="check_list[]" value="broilors"><label>&nbsp Broilors&nbsp&nbsp</label>
<input type="checkbox" name="check_list[]" value="kienyeji"><label>&nbsp Kienyeji&nbsp&nbsp</label>
</p>
