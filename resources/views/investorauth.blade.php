...
@section('content')
  <form action="{{route('authenticateinvestor')}}" class="form-2" method="post" align="center" enctype="multipart/form-data">
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
    <h1><a href="{{route('logininvestors')}}"><span class="log-in">login</span></a> or<a href="{{route('signupinvestor')}}" <span class="sign-up">sign up</span></a></h1>
    <p class="float">
