...
@section('content')
<form action="{{route('registerEmployee')}}"  method="post" class="form-2" align="center" enctype="multipart/form-data" >
<input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
  <h4><span class="welcome">welcome back our prospective Employee<b> {{Auth::user()->fullname}}</b> <br>Help us know more about your competency.<br> </span></h4>
<h5><span class="">personal Information</span></h5>
...
<p class="float">
    <label for="age"><i class=""></i>Gender</label><br>
    <select style="width: 150px;height:30px"  class="gender"name="gender" id="gender">
      <option value="0" disabled="true" selected="true">Select gender</option>
      @foreach ($counties as $county)
